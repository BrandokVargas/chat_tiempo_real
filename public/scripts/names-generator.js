// code from https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
...
export default function GetRandomName() {
  const indexRandom = function (names) {
    return Math.floor(Math.random() * names.length)
  }

  return `${left[indexRandom(left)]} ${right[indexRandom(right)]}`
}